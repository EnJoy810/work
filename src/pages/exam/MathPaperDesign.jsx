...
const MathPaperDesign = () => {
      ...
      setQuestions([
        {
          ...
          number: '1',
          type: 'single',
          content: '若函数f(x) = x² - 2x + 3，则f(2)的值为？',
          score: 5,
        },
        {
          key: '2',
          number: '2',
          type: 'blank',
          content: '已知等差数列{an}中，a1=3，公差d=2，则a5=___',
          score: 5,
        },
        {
          key: '3',
          number: '3',
          type: 'calculation',
          content: '计算：∫(x² + 3x + 2)dx 从0到2的定积分',
          score: 10,
        },
      ]);
      showSuccess('数学试卷数据加载成功');
      setLoading(false);
    }, 800);
  };
  ...
  // 预览试卷
  const previewPaper = () => {
    showInfo('预览数学试卷功能待实现');
  };

  return (
    <div style={{ padding: '24px' }}>
      <Card title="数学试卷设计" bordered={false}>
            ...
            <Row gutter={16}>
              <Col span={12}>
                <Form.Item name="title" label="试卷标题" rules={[{ required: true }]}>
                  <Input placeholder="请输入试卷标题" defaultValue="高中数学期中考试试卷" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item name="subject" label="科目" initialValue="math">
                  <Select disabled>
...
export default MathPaperDesign;